const mockData = {
    ...
    accessNodes: [
        { id: 1, name: 'Home Storage Cluster A', vpp: 'State Grid VPP', status: 'online', type: 'EDGE', inverters: 5, invertersOnline: 5, invertersOffline: 0, batteries: 10, batteriesOnline: 9, batteriesOffline: 1, ip: '192.168.1.100', country: 'Australia' },
        { id: 6, name: 'Madrid Commercial Roof', vpp: 'EU Energy Hub', status: 'online', type: 'CLOUD', inverters: 45, invertersOnline: 45, invertersOffline: 0, batteries: 0, batteriesOnline: 0, batteriesOffline: 0, vendor: 'SMA', appKey: 'manta_app_789', appAccess: 'sec_9h44c5e9f3g7', country: 'Spain', company: 'Connect Solar Cycle Team' },
        { id: 7, name: 'Amsterdam Distribution Center', vpp: 'EU Energy Hub', status: 'offline', type: 'CLOUD', inverters: 80, invertersOnline: 10, invertersOffline: 70, batteries: 20, batteriesOnline: 5, batteriesOffline: 15, vendor: 'SolarEdge', appKey: 'manta_app_012', appAccess: 'sec_1j55d6f0g4h8', country: 'Netherlands', company: 'Blue Sky Solar' },
        { id: 8, name: 'Sydney Residential VPP', vpp: 'Ausgrid VPP', status: 'online', type: 'CLOUD', inverters: 50, invertersOnline: 50, invertersOffline: 0, batteries: 50, batteriesOnline: 48, batteriesOffline: 2, vendor: 'Tesla', appKey: 'manta_app_aus1', appAccess: 'sec_aus1_tesla', country: 'Australia', company: 'Energy Australia' },
        { id: 9, name: 'Melbourne Commercial Hub', vpp: 'CitiPower Flex', status: 'online', type: 'CLOUD', inverters: 30, invertersOnline: 29, invertersOffline: 1, batteries: 0, batteriesOnline: 0, batteriesOffline: 0, vendor: 'Fronius', appKey: 'manta_app_aus2', appAccess: 'sec_aus2_fronius', country: 'Australia', company: 'Origin Energy' },
